...
// Google Fonts import for script font
...
const socialLinks = [
  {
    href: "https://github.com/TAPAN-2835",
    label: "GitHub",
    icon: (
...
const Footer = () => {
  // No need to use theme directly, DaisyUI classes handle it
  return (
    <footer
      className="w-full border-t border-base-300 py-4 px-2 flex flex-col items-center gap-2 mt-auto bg-base-200 text-base-content transition-colors duration-300"
    >
      <span
        className="font-logo text-2xl mb-1"
      ...
      <div className="flex gap-4 mb-1">
        {socialLinks.map((link) => (
          <a
            ...
            className="hover:scale-110 transition-transform text-base-content"
          >
            {link.icon}
          </a>
        ))}
